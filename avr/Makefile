...
SRC = src/main.c src/ps2_converter.c src/libs/ps2_keyb/ps2_keyb.c src/libs/amiga_keyb/amiga_keyb.c
...
CINCS = -Isrc/libs/ -Isrc/libs/ps2_keyb/ -Isrc/libs/amiga_keyb/
